...
public final class LevelSelectScene extends Scene {
    public LevelSelectScene(IEngine engine) {
        ...
        GameObject description = new Padding(0.3, 0, 0, 0).addChild(new Text("Selecciona el tamaño del puzzle",font).setHorizontalAlignment(HorizontalAlignment.CENTRE).setVerticalAlignment(VerticalAlignment.TOP));

        Grid row0 = new Grid(3, FlowDirection.HORIZONTAL);
        row0.setElement(0, new Padding(0.2).addChild(new CreateLevelButton(getEngine(),font, 4, 4)));
        row0.setElement(1, new Padding(0.2).addChild(new CreateLevelButton(getEngine(),font, 5, 5)));
        row0.setElement(2, new Padding(0.2).addChild(new CreateLevelButton(getEngine(),font, 5, 10)));

        Grid row1 = new Grid(3, FlowDirection.HORIZONTAL);
        row1.setElement(0, new Padding(0.2).addChild(new CreateLevelButton(getEngine(),font ,8, 8)));
        row1.setElement(1, new Padding(0.2).addChild(new CreateLevelButton(getEngine(), font,10, 10)));
        row1.setElement(2, new Padding(0.2).addChild(new CreateLevelButton(getEngine(), font,10, 15)));
